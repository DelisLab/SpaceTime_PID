...
%-------------------------------------------------------------------------
MAXITER=500000; % Maximum iteration before stopping is enforced
ERRTOL=1e-20; % Tolerance on the recontruction error changes
...
NSTOPS=5000; % Number of steps for the stopping criterion
